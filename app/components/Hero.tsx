    ...
    >
      ...
      <div className="container relative z-10 flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
        <div className="flex-1 text-center lg:text-left order-2 lg:order-1">
          ...
          <p className="text-white/90 text-lg md:text-xl lg:text-2xl mb-2">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
            <a
              ...
              className="inline-flex items-center justify-center gap-3 px-10 py-4 bg-accent hover:bg-amber-600 text-white font-semibold rounded-lg transition-all hover:scale-[1.02] shadow-lg min-h-[3.25rem]"
            >
            ...
            <a
              href="#servicos"
              className="inline-flex items-center justify-center gap-3 px-10 py-4 border-2 border-white text-white font-semibold rounded-lg transition-all hover:bg-white/10 min-h-[3.25rem]"
            >
              Saiba seus direitos
            </a>
          </div>
        ...
        <div className="flex-1 flex justify-center order-1 lg:order-2">
          <div className="relative w-48 h-48 sm:w-56 sm:h-56 md:w-64 md:h-64 rounded-2xl overflow-hidden bg-white/10 flex items-center justify-center shadow-2xl">
            <span className="text-6xl sm:text-7xl md:text-8xl font-serif text-white/30">
